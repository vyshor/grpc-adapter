...
public class TestObjectGenerator
{
  ...
  public static PowerType powerType = PowerType.BATTERY_STORAGE;
  ...
  static {
    //A more complicated customer info with some odd power types
    CustomerInfo ci = new CustomerInfo(STRING, INT);
    ci.withPowerType(PowerType.CHP_PRODUCTION);
    TestObjectGenerator.customerInfo = ci;

    //a more complicated competition
    competition.addCustomer(ci);
    competition.addCustomer(new CustomerInfo(STRING, INT));
    competition.addCustomer(new CustomerInfo(STRING, INT));
